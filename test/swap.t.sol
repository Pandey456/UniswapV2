...
contract addLiquidity is Test {
    ...
    function testQuantityUpdateTkn1() public {
        MockToken1.approve(address(Pool), 10000);
        Pool.swap(1000, address(MockToken1), 900);
